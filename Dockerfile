...
COPY --from=build /home/gradle/kitpvp-paper/docker-data/install/install-packages.sh /setup/
RUN /setup/install-packages.sh
COPY --from=build /home/gradle/kitpvp-paper/docker-data/install/setup-packages.sh /setup/
